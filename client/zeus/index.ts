...
export type ValueTypes = {
  ...
  ["Mutation"]: AliasType<{
    userSignIn?: [
      { payload: ValueTypes["userSingInPayload"] | Variable<any, string> },
      boolean | `@${string}`
    ];
    follow?: [
      {
        followerId: number | Variable<any, string>;
        followingId: number | Variable<any, string>;
      },
      ValueTypes["FollowResponse"]
    ];
    unfollow?: [
      {
        followerId: number | Variable<any, string>;
      ...
      ValueTypes["UnFollowResponse"]
    ];
    createTweet?: [
      { payload: ValueTypes["createTweetData"] | Variable<any, string> },
      ValueTypes["PostResult"]
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ["Query"]: AliasType<{
    ...
    getPreSignUrl?: [
      {
        id: number | Variable<any, string>;
        imageType: string | Variable<any, string>;
      },
      boolean | `@${string}`
    ];
    __typename?: boolean | `@${string}`;
...
export type ResolverInputTypes = {
  ...
  ["Mutation"]: AliasType<{
    userSignIn?: [
      { payload: ResolverInputTypes["userSingInPayload"] },
      boolean | `@${string}`
    ];
    follow?: [
      { followerId: number; followingId: number },
      ResolverInputTypes["FollowResponse"]
    ];
    unfollow?: [
      { followerId: number; followingId: number },
      ResolverInputTypes["UnFollowResponse"]
    ];
    createTweet?: [
      { payload: ResolverInputTypes["createTweetData"] },
      ResolverInputTypes["PostResult"]
    ];
    __typename?: boolean | `@${string}`;
  }>;
  ["Query"]: AliasType<{
    ...
    isFollowing?: [
      { followerId: number; followingId: number },
      ResolverInputTypes["IsFollowing"]
    ];
